...
def prepare_known_embeddings(known_embeddings):
    """
    Convert all stored student embeddings into
...
def find_track_for_face(
    ...
    """
    Associate an InsightFace face with
    a ByteTrack person.

    The center of the face must be inside
    ...
    for i in range(
        ...
        # ----------------------------------------------------
        # Select closest matching person
        # ----------------------------------------------------
...
while True:
    ...
    for face in faces:
        ...
        # ----------------------------------------------------
        # Find corresponding ByteTrack ID
        # ----------------------------------------------------
